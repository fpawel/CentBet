  ...
  CentBet:{
   Client:{
    ...
    Coupon:{
       ...
       return Seq.append([Coupon.doc(x1)],Seq.delay(function()
       {
        ...
        return Seq.append([Coupon.doc(x2)],Seq.delay(function()
        {
         ...
         return Seq.append(_,Seq.delay(function()
         {
          ...
          {
           var x5;
           x5=Doc.Element("td",List.ofArray([AttrProxy.Create("colspan","2")]),List.ofArray([Doc.TextNode("1")]));
           return Seq.append([Coupon.doc(x5)],Seq.delay(function()
           {
            var x6;
            x6=Doc.Element("td",List.ofArray([AttrProxy.Create("colspan","2")]),List.ofArray([Doc.TextNode("×")]));
            return Seq.append([Coupon.doc(x6)],Seq.delay(function()
            {
             var x7;
             x7=Doc.Element("td",List.ofArray([AttrProxy.Create("colspan","2")]),List.ofArray([Doc.TextNode("2")]));
             return[Coupon.doc(x7)];
            }));
           }));
          }));
         }));
     ...
     renderMeetup:function(inplayOnly,selectedCountry,x)
     {
            ...
            else
             {
              ...
              arg00=function(i)
              {
               ...
               if(Seq.exists(predicate,list))
                {
                 ch=Coupon.renderMeetup1(x,selectedCountry.$==1);
      ...
      return Seq.toList(Seq.delay(function()
      {
       ...
       return Seq.append([Coupon.doc(x1)],Seq.delay(function()
       {
        ...
        return Seq.append([Coupon.doc(x2)],Seq.delay(function()
        {
         ...
         _arg00_=View.Map(function(_arg1)
         {
          var _,x3;
          if(_arg1.playMinute.$==1)
           {
            _arg1.playMinute.$0;
            x3=Doc.Element("td",List.ofArray([AttrProxy.Create("class","game-status")]),List.ofArray([Doc.TextNode(_arg1.summary)]));
            _=Coupon.doc(x3);
           }
          else
           {
              ...
              })],Seq.delay(function()
              {
               ...
               })],Seq.delay(function()
               {
                ...
                })],Seq.delay(function()
                {
                 ...
                 {
                  var arg201,x7;
                  arg201=Seq.toList(Seq.delay(function()
                  {
                   var x5,arg00,_arg00_1;
                   x5=x.totalMatched.get_View();
                   arg00=function(_arg2)
                   {
                    var _,totalMatched,x6,t;
                    if(_arg2.$==1)
                     {
                      totalMatched=_arg2.$0;
                      t=Global.String(totalMatched);
                      x6=Doc.Element("span",List.ofArray([AttrProxy.Create("class","game-gpb")]),List.ofArray([Doc.TextNode(t)]));
                      _=Coupon.doc(x6);
                     }
                    else
                     {
                   ...
                   return Seq.append([Doc.EmbedView(_arg00_1)],Seq.delay(function()
                   {
                    ...
                    if(!countryIsSelected)
                     {
                      x6=Doc.Element("span",List.ofArray([AttrProxy.Create("class","game-coubtry")]),List.ofArray([Doc.TextView(x.country.get_View())]));
                      _=[Coupon.doc(x6)];
                     }
                    else
                     {
     ...
     renderMeetups:function()
     {
      ...
      _arg00_=View1.Bind(function(_arg1)
      {
       ...
       return View1.Bind(function(_arg2)
       {
        ...
        return View1.Bind(function(_arg3)
        {
         var predicate,hasInplay,arg20,arg201,x3,tupledArg,inplayOnly,selectedCountry,mapping,ch;
         ...
         tupledArg=[_arg2,_arg3];
         inplayOnly=tupledArg[0];
         selectedCountry=tupledArg[1];
         mapping=function(x4)
         {
          return Coupon.renderMeetup(inplayOnly,selectedCountry,x4);
         };
